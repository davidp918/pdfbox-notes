...
import pdfbox.CreateSignatureBase;
import pdfbox.TSAClient;
...
public class PdfSignBox extends CreateSignatureBase {
    ...
    public PdfSignBox(KeyStore keystore, char[] pin) throws KeyStoreException, UnrecoverableKeyException,
    ...
    public static void sign(char[] password, InputStream p12Input, FileInputStream imageStream, File srcPdf,
            File signed, String signerName, String reason, String location) throws Exception {
        boolean externalSig = false;
        KeyStore keystore = KeyStore.getInstance("PKCS12");
    ...
    private static void usage() {
        System.err.println(
                "Usage: java " + PdfSignBox.class.getName() + " <pkcs12-keystore-file> <pin> <input-pdf> <sign-image>\n"
